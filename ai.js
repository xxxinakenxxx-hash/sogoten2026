...
12. 商品名・素材名・カテゴリ名で複数の出展社が該当する場合は、1社だけに絞らず、検索結果・AI補助資料に該当する出展社を最大6件まで案内する。特に「ピスタチオ」のようにブース検索で複数件ヒットする語は、AI回答でも複数社を列挙する。回答本文の出展社数と「AIが案内したブース」の件数が大きくずれないようにする。
