...
function normalizeAIQueryForBooth(value) {
  ...
  if (/パン(ノ)?袋|パン用袋|食パン袋|菓子パン袋|ケーキ箱|ケーキ用箱|洋菓子箱|菓子箱|ギフト箱/.test(text)) {
    return '包材';
  }
...
- ただし、「パン袋」「パンの袋」「パン用袋」「食パン袋」「菓子パン袋」「ケーキ箱」「ケーキ用箱」「洋菓子箱」「菓子箱」「ギフト箱」は聞き返さない。食品原材料ではなく包材・包装資材として扱い、【会場の出展社（抜粋）】または【補助資料（運営からの追加情報）】から該当出展社を案内する
...
- 「パン袋」「パンの袋」「パン用袋」「食パン袋」「菓子パン袋」「ケーキ箱」「ケーキ用箱」「洋菓子箱」「菓子箱」「ギフト箱」は曖昧語ではなく、包材・包装資材として扱い、用途確認をせず、【会場の出展社（抜粋）】から包材関連の出展社を案内する
